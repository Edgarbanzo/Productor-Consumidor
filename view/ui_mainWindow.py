...
"")
        ...
        self.textBox_StatusProductor.setGeometry(QRect(110, 280, 131, 35))
...
"")
        ...
        self.label_StatusProductor.setGeometry(QRect(60, 290, 41, 16))
        self.label_StatusProductor.setStyleSheet(u"color:rgb(255, 255, 255);")
        self.labelZProductor = QLabel(self.groupBoxFirst)
        self.labelZProductor.setObjectName(u"labelZProductor")
        self.labelZProductor.setGeometry(QRect(180, 95, 51, 41))
        self.labelZProductor.setPixmap(QPixmap(u"images/zzz.png"))
        self.labelZProductor.setScaledContents(True)
        self.label_StatusProductor_2 = QLabel(self.groupBoxFirst)
        self.label_StatusProductor_2.setObjectName(u"label_StatusProductor_2")
        self.label_StatusProductor_2.setGeometry(QRect(10, 330, 101, 16))
        self.label_StatusProductor_2.setStyleSheet(u"color:rgb(255, 255, 255);")
        self.textBox_StatusProductor_2 = QLineEdit(self.groupBoxFirst)
        self.textBox_StatusProductor_2.setObjectName(u"textBox_StatusProductor_2")
        self.textBox_StatusProductor_2.setGeometry(QRect(110, 320, 131, 35))
        self.textBox_StatusProductor_2.setMinimumSize(QSize(60, 35))
        self.textBox_StatusProductor_2.setTabletTracking(True)
        self.textBox_StatusProductor_2.setAutoFillBackground(False)
        self.textBox_StatusProductor_2.setStyleSheet(u"background-color: rgb(52, 62, 64);\n"
"color: rgb(255, 255, 255);\n"
"border: 1px solid rgb(0, 153, 117);\n"
"border-radius: 4px;")
        self.label_StatusProductor_4 = QLabel(self.groupBoxFirst)
        self.label_StatusProductor_4.setObjectName(u"label_StatusProductor_4")
        self.label_StatusProductor_4.setGeometry(QRect(20, 370, 81, 16))
        self.label_StatusProductor_4.setStyleSheet(u"color:rgb(255, 255, 255);")
        self.textBox_ProductosProductor = QLineEdit(self.groupBoxFirst)
        self.textBox_ProductosProductor.setObjectName(u"textBox_ProductosProductor")
        self.textBox_ProductosProductor.setGeometry(QRect(110, 360, 131, 35))
        self.textBox_ProductosProductor.setMinimumSize(QSize(60, 35))
        self.textBox_ProductosProductor.setTabletTracking(True)
        self.textBox_ProductosProductor.setAutoFillBackground(False)
        self.textBox_ProductosProductor.setStyleSheet(u"background-color: rgb(52, 62, 64);\n"
"color: rgb(255, 255, 255);\n"
"border: 1px solid rgb(0, 153, 117);\n"
"border-radius: 4px;")
        self.groupBoxLast = QGroupBox(self.centralwidget)
        self.groupBoxLast.setObjectName(u"groupBoxLast")
        self.groupBoxLast.setGeometry(QRect(550, 10, 241, 531))
...
"")
        ...
        self.textBox_StatusConsumer.setGeometry(QRect(110, 280, 121, 35))
...
"border-radius: 4px;")
        ...
        self.label_StatusConsumer.setGeometry(QRect(60, 290, 41, 16))
        self.label_StatusConsumer.setStyleSheet(u"color:rgb(255, 255, 255);")
        self.label_ZConsumidor = QLabel(self.groupBoxLast)
        self.label_ZConsumidor.setObjectName(u"label_ZConsumidor")
        self.label_ZConsumidor.setGeometry(QRect(170, 100, 41, 31))
        self.label_ZConsumidor.setPixmap(QPixmap(u"images/zzz.png"))
        self.label_ZConsumidor.setScaledContents(True)
        self.label_StatusProductor_3 = QLabel(self.groupBoxLast)
        self.label_StatusProductor_3.setObjectName(u"label_StatusProductor_3")
        self.label_StatusProductor_3.setGeometry(QRect(10, 330, 101, 16))
        self.label_StatusProductor_3.setStyleSheet(u"color:rgb(255, 255, 255);")
        self.textBox_TiempoConsumidor = QLineEdit(self.groupBoxLast)
        self.textBox_TiempoConsumidor.setObjectName(u"textBox_TiempoConsumidor")
        self.textBox_TiempoConsumidor.setGeometry(QRect(110, 320, 121, 35))
        self.textBox_TiempoConsumidor.setMinimumSize(QSize(60, 35))
        self.textBox_TiempoConsumidor.setTabletTracking(True)
        self.textBox_TiempoConsumidor.setAutoFillBackground(False)
        self.textBox_TiempoConsumidor.setStyleSheet(u"background-color: rgb(52, 62, 64);\n"
"color: rgb(255, 255, 255);\n"
"border: 1px solid rgb(0, 153, 117);\n"
"border-radius: 4px;")
        self.label_StatusProductor_5 = QLabel(self.groupBoxLast)
        self.label_StatusProductor_5.setObjectName(u"label_StatusProductor_5")
        self.label_StatusProductor_5.setGeometry(QRect(20, 370, 81, 16))
        self.label_StatusProductor_5.setStyleSheet(u"color:rgb(255, 255, 255);")
        self.textBox_TiempoConsumidor_2 = QLineEdit(self.groupBoxLast)
        self.textBox_TiempoConsumidor_2.setObjectName(u"textBox_TiempoConsumidor_2")
        self.textBox_TiempoConsumidor_2.setGeometry(QRect(110, 360, 121, 35))
        self.textBox_TiempoConsumidor_2.setMinimumSize(QSize(60, 35))
        self.textBox_TiempoConsumidor_2.setTabletTracking(True)
        self.textBox_TiempoConsumidor_2.setAutoFillBackground(False)
        self.textBox_TiempoConsumidor_2.setStyleSheet(u"background-color: rgb(52, 62, 64);\n"
"color: rgb(255, 255, 255);\n"
"border: 1px solid rgb(0, 153, 117);\n"
"border-radius: 4px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelZProductor.setText("")
        self.label_StatusProductor_2.setText(QCoreApplication.translate("MainWindow", u"Tiempo Restante:", None))
        self.textBox_StatusProductor_2.setText("")
        self.label_StatusProductor_4.setText(QCoreApplication.translate("MainWindow", u"No. Productos:", None))
        ...
        self.label_ZConsumidor.setText("")
        self.label_StatusProductor_3.setText(QCoreApplication.translate("MainWindow", u"Tiempo Restante:", None))
        self.textBox_TiempoConsumidor.setText("")
        self.label_StatusProductor_5.setText(QCoreApplication.translate("MainWindow", u"No. Productos:", None))
